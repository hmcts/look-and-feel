...
describe('sources/customJS', () => {
    ...
    it('should create a \'from\' \'to\' structure', () => {
        const fromToStructure = createFromToStructure(assetPathOnwards(extractJSFiles(files)));
        expect(fromToStructure[0]).to.eql({ from: 'assets/js/myJSFile.js', to: 'javascripts' });
        expect(fromToStructure[1]).to.eql({ from: 'assets/javascript/myJSFile2.js', to: 'javascripts' });
